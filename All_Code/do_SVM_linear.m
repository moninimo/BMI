function pred = do_SVM_linear(Xt,Xmean,c)
model1 = svmTrain(Xmean', [0 0 1 1 1 1 0 0]', c, @(x1, x2) linearKernel(x1, x2));
model2 = svmTrain(Xmean(:,3:6)', [1 1 0 0]', c, @(x1, x2) linearKernel(x1, x2));
model3 = svmTrain(Xmean(:,[1 2 7 8])', [1 1 0 0]', c, @(x1, x2) linearKernel(x1, x2));
